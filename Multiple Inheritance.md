...
1. Define the `Student` class.# Exp.No:23  
## Multiple Inheritance
...
### RESULT
Thus a Python program to get the name, attendance, and ID of a student and check if they are eligible for the next module using multiple inheritance.  
